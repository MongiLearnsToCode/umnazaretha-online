...
export async function POST(request: Request) {
  ...
  try {
    ...
    // For audio-only, we use the audio manifest URL
    const streamUrl = `https://customer-mhnj3u59da2g04j5.cloudflarestream.com/${videoId}/manifest/audio.m3u8?token=${token}`;
